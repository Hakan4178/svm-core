...
//
// AMD APM Vol.2 §15.11: The MSR permissions map must be 12 Kbytes
// (3 pages). It covers three regions:
//   Region 0: MSR 0x00000000-0x00001FFF → offset 0x0000
//   Region 1: MSR 0xC0000000-0xC0001FFF → offset 0x0800
//   Region 2: MSR 0xC0010000-0xC0011FFF → offset 0x1000
//
#define SVM_MSR_PERMISSIONS_MAP_SIZE    (PAGE_SIZE * 3)
...
//
// CRITICAL: InterceptMisc1 bits are relative to base 96 (word 5 of intercept bitmap)
// Kernel's INTERCEPT_* constants are GLOBAL bit positions, not word-relative!
//   INTERCEPT_CPUID = 114 → bit (114-96) = 18 in InterceptMisc1
//   INTERCEPT_HLT = 120 → bit (120-96) = 24 in InterceptMisc1
//   INTERCEPT_MSR_PROT = 124 → bit (124-96) = 28 in InterceptMisc1
//   INTERCEPT_VMRUN = 128 → bit (128-128) = 0 in InterceptMisc2 (word 6, base 128)
#define SVM_INTERCEPT_MISC1_CPUID       (1UL << 18)  // Bit 18 (CPUID)
#define SVM_INTERCEPT_MISC1_HLT         (1UL << 24)  // Bit 24 (HLT)
#define SVM_INTERCEPT_MISC1_MSR_PROT    (1UL << 28)  // Bit 28 (MSR_PROT)
#define SVM_INTERCEPT_MISC2_VMRUN       (1UL << 0)   // Bit 0 (VMRUN)
